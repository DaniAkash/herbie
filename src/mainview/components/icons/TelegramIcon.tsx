...
// Official Telegram brand mark — paper plane on the blue gradient.
// Source: https://svgl.app/library/telegram.svg
// Use this variant in status-badge contexts (sidebar ✈, popup header)
// where the brand recognition matters. For currentColor-aware buttons,
// use <TelegramIcon /> below.
...
// Monochrome currentColor variant — just the paper plane, no
// background circle. Drop it in places where the icon should adapt to
// surrounding text color: composer toolbar buttons, menu items,
// disabled / hovered states. Re-uses the brand path so the silhouette
// stays recognizably Telegram even without the blue.
